...
| 数据域 | 业务过程 | 事实表 | 时间 | 车辆 | 电池 | 用户 | 故障/告警 | 地理 |
|------|--------|------|------|------|------|------|----------|------|
| 用户安全域 | 驾驶行为监测 | 行为安全报警表（如：疲劳驾驶、未系安全带） | ✓ | ✓ |  | ✓ | ✓ | ✓ |
| 用户安全域 | 安全反馈 | 安全投诉工单表 | ✓ | ✓ |  | ✓ | ✓ |  |
| 行车安全域 | 车辆行驶 | 行驶实时日志表（30秒/次，含速度、位置） | ✓ | ✓ |  |  |  | ✓ |
| 行车安全域 | 事故监测 | 事故上报记录表 | ✓ | ✓ |  | ✓ | ✓ | ✓ |
| 充电安全域 | 充电监测 | 充电过程日志表（含电压/温度/过热） | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
| 电池安全域 | 电池健康监测 | BMS状态/单体数据表 | ✓ | ✓ | ✓ |  |  |  |
| 电池安全域 | 电池告警 | 电池故障告警表 | ✓ | ✓ | ✓ |  | ✓ | ✓ |
| 报警响应域 | 应急响应 | 报警处置响应表（含客服呼叫/数据派遣） | ✓ | ✓ |  | ✓ | ✓ | ✓ |
